  ...
  getDesGiornata(campionato: string, index: number, alias: string): string {
    if (alias) {
      ...
      const mondialiMap: { [key: string]: string } = {
        ...
        'Trentaduesimi di finale':  this.translate.instant('LEAGUE.ROUND_LABELS.ROUND_OF_64'),
        'Sedicesimi di finale':     this.translate.instant('LEAGUE.ROUND_LABELS.ROUND_OF_32'),
        'Ottavi di finale':         this.translate.instant('LEAGUE.ROUND_LABELS.ROUND_OF_16'),

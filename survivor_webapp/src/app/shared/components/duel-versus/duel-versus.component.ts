...
@Component({
  ...
  styles: [`
    ...
    .dv {
      ...
      box-shadow: 0 6px 20px rgba(10, 61, 145,0.12);
      overflow: hidden;
    }
    .dv::before {
      content: '';
      position: absolute;
      inset: 0;
      background: radial-gradient(circle at 50% 50%, rgba(129, 212, 250,0.35), transparent 60%);
      pointer-events: none;
    }
    ...
    .dv-avatar {
      ...
      background: linear-gradient(150deg, #81D4FA, #4FC3F7 55%, #0A3D91);
    ...
    .dv-status--wait { color: #0A3D91; background: rgba(79, 195, 247,0.14); white-space: normal; line-height: 1.25; }
    ...
    .dv-swords {
      font-size: 1.7rem;
      line-height: 1;
      filter: drop-shadow(0 2px 4px rgba(10, 61, 145,0.4));

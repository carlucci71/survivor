...
@Component({
  ...
  styles: [`
    ...
    .dv {
      ...
      border-radius: 18px;
      background: linear-gradient(135deg, rgba(139,90,43,0.08), rgba(205,127,50,0.14));
    ...
    .dv::before {
      ...
      position: absolute;
      inset: 0;
      background: radial-gradient(circle at 50% 50%, rgba(232,196,160,0.35), transparent 60%);
      pointer-events: none;
    }
    ...
    .dv-avatar {
      ...
      background: linear-gradient(150deg, #E8C4A0, #CD7F32 55%, #8B5A2B);
      border: 2px solid rgba(255,255,255,0.7);
      box-shadow: 0 4px 12px rgba(139,90,43,0.35);
    }
    .dv-me .dv-avatar { box-shadow: 0 0 0 3px rgba(205,127,50,0.35), 0 4px 12px rgba(139,90,43,0.35); }
    .dv-avatar--empty {
      background: transparent;
      color: #CD7F32;
      border: 2px dashed rgba(205,127,50,0.6);
      box-shadow: none;
    ...
    .dv-status--wait { color: #8B5A2B; background: rgba(205,127,50,0.14); white-space: normal; line-height: 1.25; }
    ...
    .dv-finger {
      ...
      background: linear-gradient(180deg, #E8C4A0, #CD7F32);

...
@Component({
  ...
  styles: [`
    ...
    .hero-title {
      ...
      animation: fadeInScale 1s ease-out forwards, shine 5s linear 1s infinite;
    }
    .hero-subtitle {
      font-size: 1.3rem;
      font-weight: 400;
      ...
      width: 0;
      animation:
        type-and-vanish 7s steps(15, end) 1s infinite,
        blink-caret-timed 1s step-end 1s infinite;
...
export class HeroThreeComponent implements OnInit {
  ...
  ngOnInit(): void {
    // Componente usa solo animazioni CSS
  }
}

...
public interface GiocatoreRepository extends JpaRepository<Giocatore, Long> {
    @Query("SELECT g.id as id, g.nome as nome, g.nickname as nickname, sc as squadraCuore, g.user as user FROM Giocatore g LEFT JOIN g.squadraCuore sc WHERE g.user.id = :userId")
